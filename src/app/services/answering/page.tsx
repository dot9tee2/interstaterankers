...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: `${service.title} | InterStateRankers`,
        description: service.description,
        url: `/services/answering`,
        type: "website",
    },
    alternates: {
        canonical: `/services/answering`
    }
};
            ...
            <Script id="service-jsonld" type="application/ld+json" strategy="afterInteractive"
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        url: `https://interstaterankers.com/services/answering`,
                        brand: {
                            "@type": "Brand",
                            name: "InterStateRankers"
                        }
                    ...
                    __html: JSON.stringify({
                        ...
                        itemListElement: [
                            ...
                            },
                            {
                                ...
                                position: 3,
                                name: service.title,
                                item: `https://interstaterankers.com/services/answering`
                            }
                        ]
                    })
                }}
