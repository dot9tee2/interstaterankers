...
const Navbar = () => {
  ...
  return (
    <nav className={cn(
      "fixed top-4 left-0 right-0 z-50 mx-auto w-[95%] max-w-7xl rounded-full shadow-2xl",
      ...
      "border-[1px] border-transparent animate-border"
    )}>
      {/* Inner container for background and content */}
      <div className={cn(
        "w-full h-full rounded-full bg-slate-950/95 backdrop-blur-lg px-6 flex items-center justify-between transition-all duration-300",
            ...
            <div key={item.name} className="relative">
              {item.hasDropdown ? (
                ...
                >
                  <button
                    className={cn(
                      "relative flex items-center space-x-1 text-base font-medium transition-transform duration-200 hover:scale-105 hover-accent-cyan-dark",
                ...
                <Link
                  href={item.href}
                  className={cn(
                    "relative text-base font-medium transition-transform duration-200 hover:scale-105 hover-accent-cyan-dark",
                    pathname === item.href
                      ? "active-accent-cyan"
                      : "text-foreground/80"
                  )}
