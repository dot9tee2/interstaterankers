...
const service = {
    ...
    description: "Dominate local search. We optimize your Google Business Profile to increase visibility, drive local traffic, and attract more customers.",
    longDescription: undefined,
    keywords: ["Google Business Profile", "local SEO", "GMB optimization", "local maps ranking", "Google Maps marketing"],
    features: ["Profile Setup & Optimization", "Review Management", "Post Management", "Local Citations", "Performance Tracking"],
    process: undefined,
    benefits: undefined,
    faqs: undefined
};
            ...
            <Script id="service-jsonld" type="application/ld+json" strategy="afterInteractive"
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        url: `https://interstaterankers.com/services/gmb`,
                        brand: {
                            "@type": "Brand",
                            name: "InterStateRankers"
                        }
                    ...
                    __html: JSON.stringify({
                        ...
                        itemListElement: [
                            ...
                            },
                            {
                                ...
                                position: 3,
                                name: service.title,
                                item: `https://interstaterankers.com/services/gmb`
                            }
                        ]
                    })
                }}
